...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "YmF0YXRlc3RlMTIzQGdtYWlsLmNvbQ=="; //batateste123@gmail.com em base 64
        const char* EMAILBASE64_PASSWORD = "QkB0YXRlc3RlMTIz"; //B@tateste123
        const char* FROM = "batateste123@gmail.com";
